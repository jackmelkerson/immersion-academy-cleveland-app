...
exports.handler = async function (event) {
  // Our functions use the classic Lambda-style handler signature, so Blobs needs to be
  // connected to this specific request manually before getStore() will work.
  connectLambda(event);
